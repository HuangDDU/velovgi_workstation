...
# adata_filename = "/home/huang/PyCode/scRNA/data/Gastrulation/gastrulation.h5ad" # 实验室服务器的数据路径
adata_filename = "/home/21031211625/Code/rna_velocity_expirement/data/Gastrulation/gastrulation.h5ad" # 集群服务器的数据路径
...
scv.pl.velocity_embedding_stream(adata, color=cluster_key, legend_loc="right margin")
adata
